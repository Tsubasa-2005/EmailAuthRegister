...
export default function useEmailVerificationAndRegisterAdapter() {
    ...
    const sendVerificationEmail = useCallback(
        async (params: SendEmailVerificationOperationRequest) => {
            ...
            await postSendVerificationHelper(params, setError, {setSuccessMessage, message: "Verification email sent successfully"});
    ...
    const verifyToken = useCallback(
        async (params: VerifyEmailOperationRequest) => {
            ...
            await postVerificationHelper(params, setEmail, setExpired, setError, {setSuccessMessage, message: "Email verified successfully"});
            setIsSubmitting(false);
        },
        []
    );
